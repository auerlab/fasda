    ...
    for (c1 = 0; c1 < fc_count; c1 += increment)
     for (c2 = c1 + 1; c2 < fc_count; c2 += increment)
      for (c3 = c2 + 1; c3 < fc_count; c3 += increment)
       for (c4 = c3 + 1; c4 < fc_count; c4 += increment)
        for (c5 = c4 + 1; c5 < fc_count; c5 += increment)
         for (c6 = c5 + 1; c6 < fc_count; c6 += increment)
         {
     ...
     for (c2 = c1 + 1; c2 < fc_count; c2 += increment)
      for (c3 = c2 + 1; c3 < fc_count; c3 += increment)
       for (c4 = c3 + 1; c4 < fc_count; c4 += increment)
        for (c5 = c4 + 1; c5 < fc_count; c5 += increment)
         for (c6 = c5 + 1; c6 < fc_count; c6 += increment)
          for (c7 = c6 + 1; c7 < fc_count; c7 += increment)
          {
      ...
      for (c3 = c2 + 1; c3 < fc_count; c3 += increment)
       for (c4 = c3 + 1; c4 < fc_count; c4 += increment)
        for (c5 = c4 + 1; c5 < fc_count; c5 += increment)
         for (c6 = c5 + 1; c6 < fc_count; c6 += increment)
          for (c7 = c6 + 1; c7 < fc_count; c7 += increment)
           for (c8 = c7 + 1; c8 < fc_count; c8 += increment)
           {
       ...
       for (c4 = c3 + 1; c4 < fc_count; c4 += increment)
        for (c5 = c4 + 1; c5 < fc_count; c5 += increment)
         for (c6 = c5 + 1; c6 < fc_count; c6 += increment)
          for (c7 = c6 + 1; c7 < fc_count; c7 += increment)
           for (c8 = c7 + 1; c8 < fc_count; c8 += increment)
            for (c9 = c8 + 1; c9 < fc_count; c9 += increment)
            {
        ...
        for (c5 = c4 + 1; c5 < fc_count; c5 += increment)
         for (c6 = c5 + 1; c6 < fc_count; c6 += increment)
          for (c7 = c6 + 1; c7 < fc_count; c7 += increment)
           for (c8 = c7 + 1; c8 < fc_count; c8 += increment)
            for (c9 = c8 + 1; c9 < fc_count; c9 += increment)
             for (c10 = c9 + 1; c10 < fc_count; c10 += increment)
             {

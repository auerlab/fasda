...
int bl_gff3_find_overlapping_alignment(bl_gff3_t *feature, FILE *sam_stream, FILE *buffer_stream, char *previous_alignment_chrom, bl_sam_t *alignment, bl_alignment_stats_t *alignment_stats, int flags);
double count_coverage(bl_gff3_t *feature, bl_sam_t *alignment, FILE *sam_stream, FILE *buffer_stream, char *previous_alignment_chrom, bl_alignment_stats_t *alignment_stats, int flags);
int print_abundance(FILE *abundance_stream, bl_gff3_t *feature, int64_t length, double est_counts, int flags);

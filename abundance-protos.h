...
int stringtie_abundance(const char *feature_file, char *sam_files[], FILE *abundance_streams[], int file_count, const char *feature_type, unsigned read_length, int flags);
